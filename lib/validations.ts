...
/** Dashboard "destacar" bid entered by the owner, in whole dollars. $0 is valid
 *  and means "don't pay" (leaves the paid section); any positive bid is >= $1
 *  (Dodo's minimum charge). No $5 floor. */
